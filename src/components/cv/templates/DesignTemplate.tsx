...
export default function DesignTemplate({ cvData }: DesignTemplateProps) {
  ...
  return (
    <div className="bg-white text-gray-900 max-w-4xl mx-auto p-8" id="cv-content">
      {/* Header */}
      <div className="bg-gradient-to-br from-orange-400 via-red-500 to-pink-600 text-white p-8 rounded-3xl mb-8 relative overflow-hidden">
        ...
        <div className="relative z-10">
          <div className="flex items-center justify-between">
            <div>
              ...
              <p className="text-2xl text-orange-100 mb-4">{personalInfo.title}</p>
              <p className="text-orange-100 max-w-2xl leading-relaxed">{personalInfo.summary}</p>
            </div>
                ...
                {workExperience.map((exp, index) => (
                  <div key={exp.id} className="relative">
                    <div className="flex items-start space-x-4">
                      ...
                      <div className="flex-1 bg-gradient-to-r from-orange-50 to-red-50 p-6 rounded-2xl border border-orange-200">
              ...
              <div className="space-y-4">
                {education.map((edu, index) => (
                  <div key={edu.id} className="flex items-start space-x-4">
                    ...
                    <div className="flex-1 bg-gradient-to-r from-red-50 to-pink-50 p-6 rounded-2xl border border-red-200">
                      <div className="flex justify-between items-start mb-2">
                        <div>
                          <h3 className="text-lg font-semibold text-gray-900">{edu.degree}</h3>
                          <p className="text-red-600 font-medium">{edu.school}</p>
                    ...
                    {project.technologies && project.technologies.length > 0 && (
                      <div className="flex flex-wrap gap-2">
                        {project.technologies.map((tech, index) => (
                          <span 
                            key={index}
                            className="bg-gradient-to-r from-orange-500 to-red-500 text-white text-xs px-3 py-1 rounded-full"
                          >
                            {tech}
                          </span>
                        ))}
            ...
            <section>
              ...
              <div className="space-y-3">
                {skills.technical.map((skill, index) => (
                  <div key={index} className="bg-gradient-to-r from-orange-50 to-red-50 p-4 rounded-lg">
            ...
            <section>
              ...
              <div className="space-y-3">
                {skills.soft.map((skill, index) => (
                  <div key={index} className="bg-gradient-to-r from-red-50 to-pink-50 p-4 rounded-lg">
                    <div className="flex justify-between items-center mb-2">
                      <span className="text-sm font-medium text-gray-900">{skill.name}</span>
                      <span className="text-xs text-gray-600">{skill.level}%</span>
                    </div>
            ...
            <section>
              ...
              <div className="space-y-3">
                {skills.languages.map((language, index) => (
                  <div key={index} className="bg-gradient-to-r from-orange-50 to-pink-50 p-3 rounded-lg text-center">
            ...
            <section>
              ...
              <div className="space-y-3">
                {certifications.map((cert) => (
                  <div key={cert.id} className="bg-gradient-to-r from-orange-50 to-red-50 p-4 rounded-lg border border-orange-200">
