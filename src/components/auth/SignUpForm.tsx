...
export default function SignUpForm() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    if (password.length < 6) {
      error("Password must be at least 6 characters", "Please choose a stronger password");
      return;
    }

    if (!isChecked) {
      error("Please accept the terms and conditions", "You must agree to the terms to continue");
      return;
    }
