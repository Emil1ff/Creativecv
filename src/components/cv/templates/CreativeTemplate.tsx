...
export default function CreativeTemplate({ cvData }: CreativeTemplateProps) {
  ...
  return (
    <div className="bg-white text-gray-900 max-w-4xl mx-auto p-8" id="cv-content">
      {/* Header */}
      <div className="bg-gradient-to-br from-purple-600 via-pink-500 to-red-500 text-white p-8 rounded-3xl mb-8 relative overflow-hidden">
        ...
        <div className="relative z-10">
          <div className="flex items-center justify-between">
            <div>
              ...
              <p className="text-2xl text-purple-100 mb-4">{personalInfo.title}</p>
              <p className="text-purple-100 max-w-2xl leading-relaxed">{personalInfo.summary}</p>
            </div>
                ...
                {workExperience.map((exp, index) => (
                  <div key={exp.id} className="relative">
                    <div className="flex items-start space-x-4">
                      ...
                      <div className="flex-1 bg-gradient-to-r from-purple-50 to-pink-50 p-6 rounded-2xl border border-purple-200">
              ...
              <div className="space-y-4">
                {education.map((edu, index) => (
                  <div key={edu.id} className="flex items-start space-x-4">
                    ...
                    <div className="flex-1 bg-gradient-to-r from-pink-50 to-red-50 p-6 rounded-2xl border border-pink-200">
            ...
            <section>
              ...
              <div className="flex flex-wrap gap-6">
                {projects.map((project) => (
                  <div key={project.id} className="bg-gradient-to-br from-purple-50 to-pink-50 p-6 rounded-2xl border border-purple-200 w-full md:w-[calc(50%-0.75rem)]">
                    <div className="flex justify-between items-start mb-3">
                      <div>
            ...
            <section>
              ...
              <div className="space-y-3">
                {skills.soft.map((skill, index) => (
                  <div key={index} className="bg-gradient-to-r from-pink-50 to-red-50 p-4 rounded-lg">
                    <div className="flex justify-between items-center mb-2">
                      <span className="text-sm font-medium text-gray-900">{skill.name}</span>
                      <span className="text-xs text-gray-600">{skill.level}%</span>
                    </div>
            ...
            <section>
              ...
              <div className="space-y-3">
                {skills.languages.map((language, index) => (
                  <div key={index} className="bg-gradient-to-r from-purple-50 to-pink-50 p-3 rounded-lg text-center">
            ...
            <section>
              ...
              <div className="space-y-3">
                {certifications.map((cert) => (
                  <div key={cert.id} className="bg-gradient-to-r from-purple-50 to-pink-50 p-4 rounded-lg border border-purple-200">
